...
public class Arith {
	...
	public static String getPrices(String... prices) {
		double resultDouble = 0;
		for (String string : prices) {
			resultDouble = add(resultDouble, Double.parseDouble(string));
		}
	...
	public static String roundPrice(String str) {
		...
		System.err.println("b.doubleValue():" + b.doubleValue());
		return b.toString();
	}
